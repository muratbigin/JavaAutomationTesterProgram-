	...
	public static void main(String[] args) {
		 ...
		 */
		 ...
		 //4) Replace * for all numbers in your password
			...
			System.out.println(p.replaceAll("\\d", "*"));// Hey Come*? 
		 ...
		 //    Find the length of your password before trim and after trim.
			...
			System.out.println("Before trim:  " + p.length());   //Before trim:  13  
			System.out.println("After trim:  " + p.trim().length());//After trim:  10
